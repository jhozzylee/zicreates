...
const WhoWeAre = () => {
  ...
  return (
    <section id="expertise" className="bg-background text-neutral py-20 px-4 pt-20 scroll-mt-20">
      <div className="max-w-[1280px] mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8 place-items-center">
          {/* Pillar 1 */}
          <div className="bg-gradient-to-b from-[#9AFFF71A] to-[#35504E1A] rounded-[16px] w-full max-w-[352px] py-[32px] px-[40px] border-background hover:border hover:border-[#30D5C833] transition-all duration-200">
            <div className="bg-background p-[10px] rounded-[40px] inline-block mb-4">
              <Infinity className="w-6 h-6 text-neutral" />
            </div>
            <h4 className="text-[18px] font-bold mb-2 max-w-[160px]">
              Flexible & Unlimited
            </h4>
            <p className="text-[16px]">
              Custom branding and visuals tailored to your business, with unlimited refinements until it's just right.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-b from-[#9AFFF71A] to-[#35504E1A] rounded-[16px] w-full max-w-[352px] py-[32px] px-[40px] border-background hover:border hover:border-[#30D5C833] transition-all duration-200">
            <div className="bg-background p-[10px] rounded-[40px] inline-block mb-4">
              <Check className="w-6 h-6 text-neutral" />
            </div>
            <h4 className="text-[18px] font-bold mb-2 max-w-[160px]">
              Subscribe & Start Instantly
            </h4>
            <p className="text-[16px]">
              Get expert branding, motion design, and digital visuals without the wait—ready when you are.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-b from-[#9AFFF71A] to-[#35504E1A] rounded-[16px] w-full max-w-[352px] py-[32px] px-[40px] border-background hover:border hover:border-[#30D5C833] transition-all duration-200">
            <div className="bg-background p-[10px] rounded-[40px] inline-block mb-4">
              <ChevronsRight className="w-6 h-6 text-neutral" />
            </div>
            <h4 className="text-[18px] font-bold mb-2 max-w-[160px]">
              Fast & Reliable Delivery
            </h4>
            <p className="text-[16px]">
              Premium designs, delivered with speed and precision to keep your brand ahead of the curve.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-[1280px] mt-24 grid md:grid-cols-2 gap-12 items-center gap-[90px]">
          {/* Video Box */}
          <div className="relative w-full max-w-[592] rounded-[16px] overflow-hidden">
            <video
            ...
            <button
              onClick={() => setOpen(true)}
              className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2  text-white p-4 rounded-full transition hover:scale-105 transition-transform duration-300 "
            >
      ...
      <ModalVideo
        channel="vimeo"
        isOpen={isOpen}
        videoId="1102249418" // Replace with your real Vimeo ID
